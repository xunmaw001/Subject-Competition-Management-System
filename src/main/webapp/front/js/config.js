...
var centerMenu = [
    ...
    ,{
        name: '竞赛项目',
        url: '../jingsaiTijiao/list.html'
    }
    ,{
        name: '竞赛报名',
        url: '../jingsaiYuyue/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '竞赛项目信息',
        url: './pages/jingsai/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/xuekejingsaiguanlixitong/admin/dist/index.html#/login";
