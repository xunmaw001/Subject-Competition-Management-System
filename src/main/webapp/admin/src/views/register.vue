    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">学科竞赛管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            ...
                            <el-form-item label="老师头像" class="input" v-if="tableName=='laoshi'">
                                    <file-upload
                                        tip="点击上传老师头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <el-form-item label="老师邮箱" class="input" v-if="tableName=='laoshi'">
                            <el-input v-model="ruleForm.laoshiEmail" autocomplete="off" placeholder="老师邮箱"  />
                        </el-form-item>
                        <!--
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/xuekejingsaiguanlixitong/img/back-img-bg.jpg);
      ...
      box-sizing: border-box;
			...
			background-color: rgba(226, 226, 223, 1);
