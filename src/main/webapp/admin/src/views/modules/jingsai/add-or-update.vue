        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="竞赛信息" prop="jingsaiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jingsaiContent" label="竞赛信息" prop="jingsaiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jingsaiContent: [
                              { required: true, message: '竞赛信息不能为空', trigger: 'blur' },
                          ],
                   jingsaiDelete: [
